document.addEventListener("DOMContentLoaded", function () {
  ...
  // Show loader until the first image is ready or fallback
  preloadImages[0].onload = () => {
    const timeElapsed = Date.now() - loaderStart;
    const remainingTime = Math.max(0, 500 - timeElapsed); // Ensure minimum wait
  ...
  // Fallback loader timeout (in case image loading fails or is too slow)
  setTimeout(() => {
  ...
  }, 3000); // Force hide loader after 3 seconds
});
